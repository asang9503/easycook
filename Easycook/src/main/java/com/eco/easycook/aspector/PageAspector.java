package com.eco.easycook.aspector;

import com.eco.easycook.contants.PageContants;
...
public class PageAspector {
    ...
    @Pointcut("execution(* com.eco.easycook.service.impl.*.*List(java.lang.String, java.lang.String,..))")
